          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                {isSignUp ? 'Start saving your configurations' : 'Sign in to continue'}
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-slate-500 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-2">
              ...
              {isSignUp && (
                <p className="text-xs text-slate-500 dark:text-slate-500 mt-1">Password must be at least 6 characters long</p>
              )}
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700/50">
            <button
              ...
              className="w-full text-center text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
            >
              {isSignUp ? (
                <>
                  Already have an account? <span className="text-green-600 dark:text-green-400 font-medium">Sign in</span>
                </>
              ) : (
                <>
                  Don't have an account? <span className="text-green-600 dark:text-green-400 font-medium">Sign up</span>
                </>
              )}
            </button>
          </div>
