  ...
  return (
    <div className="min-h-screen py-16 px-6 bg-slate-950">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Bins & Boxes</h3>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Baseplates</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Lids</h3>
              <p className="text-slate-300 mb-3">
        ...
        {/* Extended Features */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Extended Features</h2>
          <div className="space-y-6">
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Wall Patterns</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Wall Cutouts</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Fractional Unit Sizes</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Dividers & Trays</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Labels</h3>
              <p className="text-slate-300 mb-3">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Magnet & Screw Mounts</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Split Baseplates</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Custom Cutouts</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Lip Styles</h3>
              <p className="text-slate-300 mb-3">
        ...
        {/* UI Features */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">User Interface Features</h2>
          <div className="space-y-6">
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Real-Time 3D Preview</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Generation Modes</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Export Options</h3>
              <p className="text-slate-300 mb-3">
