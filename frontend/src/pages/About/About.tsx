    ...
    <div className="min-h-screen py-16 px-6 bg-slate-950">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">The History of Gridfinity</h2>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-2 mb-4">
              <li><strong className="text-white">Fractional Unit Support:</strong> Half-grid sizes (21mm) and custom dimensions</li>
              <li><strong className="text-white">Wall Patterns:</strong> Decorative patterns like brick, sieve, and custom textures</li>
              <li><strong className="text-white">Advanced Cutouts:</strong> Custom cutouts on any side, not just standard openings</li>
              <li><strong className="text-white">Sliding Lids:</strong> Optional sliding lids with various configurations</li>
              <li><strong className="text-white">Internal Organization:</strong> Dividers, trays, and item holders</li>
              <li><strong className="text-white">Split Parts:</strong> Large baseplates can be split for easier printing</li>
              <li><strong className="text-white">Enhanced Baseplates:</strong> Multiple mounting options (magnets, screws, weighted)</li>
            </ul>
            <p className="text-slate-300 text-lg leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-slate-300 text-lg leading-relaxed mb-4">
              This <strong className="text-white">Gridfinity Extended Generator</strong> is built directly on top 
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-2 mb-4">
              <li><strong className="text-white">Comprehensive Documentation:</strong> Detailed explanations of all features and how to use them</li>
              <li><strong className="text-white">Web Interface:</strong> Easy-to-use browser-based interface with real-time preview</li>
              <li><strong className="text-white">Local Generation:</strong> WASM support for generating STLs entirely in your browser</li>
              <li><strong className="text-white">Server Generation:</strong> Faster server-side generation for complex models</li>
              <li><strong className="text-white">SEO-Friendly Pages:</strong> Multiple pages explaining Gridfinity, features, and comparisons</li>
              <li><strong className="text-white">Donation System:</strong> Built-in crypto donation support to fund development</li>
            </ul>
            <p className="text-slate-300 text-lg leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-slate-300 text-lg leading-relaxed mb-4">
              <strong className="text-white">Frontend:</strong> Built with React, TypeScript, and Vite. Uses Three.js 
        ...
        {/* Citations */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Citations & Resources</h2>
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
            <ul className="space-y-3 text-slate-300">
              <li>
                <strong className="text-white">Gridfinity by Zack Freedman:</strong>{' '}
                <a
                  href="https://www.youtube.com/watch?v=ra_9zU-mnl8"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <strong className="text-white">Gridfinity Extended by ostat:</strong>{' '}
                <a
                  href="https://github.com/ostat/gridfinity_extended_openscad"
                  target="_blank"
                  rel="noopener noreferrer"
