  ...
  return (
    <div className="min-h-screen py-16 px-6 bg-slate-950">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-4">Gridfinity Generator Comparison</h1>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-slate-800 border-b border-slate-700">
                ...
                <th className="px-6 py-4 text-center text-white font-semibold">Our Generator</th>
                <th className="px-6 py-4 text-center text-white font-semibold">MakerWorld (ostat)</th>
                <th className="px-6 py-4 text-center text-white font-semibold">Perplexing Labs</th>
                <th className="px-6 py-4 text-center text-white font-semibold">cq-gridfinity</th>
                <th className="px-6 py-4 text-center text-white font-semibold">FusionGridfinity</th>
              </tr>
            </thead>
            <tbody className="text-slate-300">
              ...
              <tr className="border-b border-slate-800">
                ...
                <td className="px-6 py-4 text-center text-green-400">✓</td>
                <td className="px-6 py-4 text-center text-yellow-400">GitHub Only</td>
                <td className="px-6 py-4 text-center text-yellow-400">Basic</td>
                <td className="px-6 py-4 text-center text-yellow-400">GitHub Only</td>
                <td className="px-6 py-4 text-center text-yellow-400">GitHub Only</td>
              </tr>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Detailed Tool Breakdown</h2>
          
          <div className="space-y-8">
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">MakerWorld (ostat's Gridfinity Extended)</h3>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">Perplexing Labs Gridfinity Generator</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">cq-gridfinity (Python/CadQuery)</h3>
              <p className="text-slate-300 mb-3">
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
              <h3 className="text-2xl font-semibold text-white mb-3">FusionGridfinityGenerator (Fusion 360 Add-in)</h3>
              <p className="text-slate-300 mb-3">
        ...
        {/* Our Advantages */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">What Sets Our Generator Apart</h2>
          <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6">
            <ul className="space-y-3 text-slate-300">
              <li>
                <strong className="text-white">✓ Full Extended Feature Support:</strong> All features from Gridfinity 
                Extended including fractional sizes, wall cutouts, patterns, and more.
              </li>
              <li>
                <strong className="text-white">✓ Local Generation:</strong> Generate STLs entirely in your browser 
        ...
        {/* When to Use Each */}
        <section>
          <h2 className="text-3xl font-bold text-white mb-6">When to Use Each Tool</h2>
          <div className="space-y-4 text-slate-300">
            <p>
              <strong className="text-white">Our Generator:</strong> Best for users who want all Extended features 
              with a great web interface, local generation capability, and comprehensive documentation.
            </p>
            <p>
              <strong className="text-white">MakerWorld:</strong> Good if you already use MakerWorld and want 
